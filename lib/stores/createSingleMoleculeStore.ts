...
export interface SingleMoleculeState {
...
export function createSingleMoleculeStoreInstance() {
  return createStore<SingleMoleculeState>((set, get) => ({
    datasets: new Map(),
...
export type SingleMoleculeStore = ReturnType<
  typeof createSingleMoleculeStoreInstance
>;
