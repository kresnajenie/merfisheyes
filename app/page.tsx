    ...
    <>
      ...
      <section className="relative flex flex-col items-center gap-1 py-12 md:py-20 px-4 md:px-8">
        ...
        <div className="relative z-10 flex flex-col items-center gap-8 max-w-5xl w-full">
          <div className="relative w-full max-w-5xl min-h-[360px] flex flex-col gap-6 items-center justify-center md:min-h-[420px]">
            <div
              className={clsx(
                "hidden md:flex absolute inset-0 items-center justify-center transition-opacity duration-[1100ms] ease-out pointer-events-none",
            ...
            <div
              className={clsx(
                "w-full transition-all duration-[1100ms] ease-[cubic-bezier(0.22,1,0.36,1)] origin-center md:absolute md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2",
                isSingleMolecule
                  ? "hidden md:block md:scale-[1.2] md:opacity-0 md:blur-sm md:pointer-events-none"
                  : "block md:block md:scale-100 md:opacity-100 md:blur-0 md:pointer-events-auto"
              )}
            >
            ...
            <div
              className={clsx(
                "w-full max-w-3xl transition-all duration-[1100ms] ease-[cubic-bezier(0.22,1,0.36,1)] md:absolute md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2",
                isSingleMolecule
                  ? "block md:block md:opacity-100 md:scale-100 md:pointer-events-auto"
                  : "hidden md:block md:opacity-0 md:scale-90 md:pointer-events-none"
              )}
            >
