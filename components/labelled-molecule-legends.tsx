  ...
  return (
    <>
      {/* Which column drives colour. Always shown, so the scene is never
          ...
          Top-left, above the controls rail — which starts at top-48 to leave
          room for it. Kept out of the right-hand stack so the selected-value
          pills have that column to themselves. */}
      <div
        data-ui-overlay
        className={`absolute left-4 top-24 z-[var(--z-legends)] w-64 p-3 ${glassPanel()}`}
      >
